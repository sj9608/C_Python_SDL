...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   CreateWindow(L"button", // - 버튼
       ...
       WS_CHILD | WS_VISIBLE | WS_BORDER,
       230, 300, 120, 40,
       hWnd, (HMENU)4002, hInst, NULL);

   CreateWindow(L"button", // * 버튼
       L"x",
       WS_CHILD | WS_VISIBLE | WS_BORDER,
       100, 350, 120, 40,
       hWnd, (HMENU)4003, hInst, NULL);

   CreateWindow(L"button", // / 버튼
       L"/",
       WS_CHILD | WS_VISIBLE | WS_BORDER,
       230, 350, 120, 40,
       hWnd, (HMENU)4004, hInst, NULL);

   CreateWindow(L"button", // = 버튼
       L"=",
       WS_CHILD | WS_VISIBLE | WS_BORDER,
       100, 400, 250, 40,
       hWnd, (HMENU)4005, hInst, NULL);
    ...
    case WM_COMMAND:
        {
            ...
            case 4001:
                ...
                GetWindowText(GetDlgItem(hWnd, 3001), szTemp, sizeof(szTemp) / sizeof(TCHAR)); // 입력텍스트 값 szTemp로 옮기기
                
                

                SetWindowText(GetDlgItem(hWnd, 2001), szTemp); // 출력텍스트 
                SetWindowText(GetDlgItem(hWnd, 3001), NULL); // 입력텍스트 값 초기화
